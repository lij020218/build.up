...
public struct FoundOneWordmark: View {
    ...
    public var body: some View {
        Canvas { context, size in
            ...
            let letters = Self.buildPath(Self.letters, sx: sx, sy: sy)
