...
public struct FloatingInspirationView: View {
    ...
    // 모바일 배치 — 카드 레이어가 입력 위에 떠 있어(빈 영역 탭 통과) 텍스트를 가리면 안 됨.
    //  헤더(뒤로·eyebrow·제목·부제), 입력 에디터, "다음" 버튼 영역을 모두 비우고
    //  ① 상단 우측 코너(제목 위쪽 빈 곳) 소수 + ② "다음" 버튼 아래 넓은 빈 공간에 풍성하게.
    private static let positions: [(CGFloat, CGFloat)] = [
        // 상단 우측 코너 (제목·eyebrow·뒤로버튼 회피)
        (62, 6), (80, 8), (93, 6),
        // 하단 빈 영역 ("다음" 버튼 아래, y>0.62) — 4행 분산
        (12, 66), (34, 68), (56, 66), (78, 67), (93, 70),
        (8, 77), (27, 78), (47, 76), (67, 78), (87, 77),
        (16, 86), (38, 88), (60, 86), (83, 88),
        (28, 95), (52, 95), (74, 95),
    ]
