...
public enum OperationsDetailRegistry {
    ...
    public static let van: [Item] = [
        .init(name: "NICE정보통신", tagline: "국내 1위 VAN · 업종 무관 안정적", url: "https://www.nicevan.co.kr", pros: ["국내 시장 점유율 1위 — 모든 카드사·간편결제 자동 연계", "전국 A/S망, 사고·장애 대응 빠름", "사업자등록증·통장사본·신분증만 있으면 신청"], cons: ["VAN 수수료(건당 약 100~150원)는 카드 수수료와 별개", "단말기 임대·구매 옵션별 비용 차이 큼"]),
    ...
    public static let design: [Item] = [
        ...
        .init(name: "미리캔버스/Canva", tagline: "셀프 디자인 · 무료~월 6천원 · 시간 투입 필요", url: "https://www.miricanvas.com", pros: ["로고·메뉴판·간판 시안 셀프 제작 (수십만 템플릿)", "무료 플랜 + 프로 월 6,000원~", "수정·재사용 무한 — 시즌 변경 시 빠르게 대응"], cons: ["디자인 시간 투입 多 (1~2주)", "독창성 ↓ — 다른 매장과 비슷할 수 있음"]),
    ]
}
