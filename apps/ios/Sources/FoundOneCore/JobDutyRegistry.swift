...
public enum JobDutyRegistry {
    ...
    public static let dutiesByCategory: [String: [BUJobDuty]] = [
        ...
        "startup-tech": [
            .init(key: "backend", ko: "백엔드 개발", en: "Backend"),
            .init(key: "frontend", ko: "프론트엔드 개발", en: "Frontend"),
            .init(key: "fullstack", ko: "풀스택 개발", en: "Full-stack"),
            .init(key: "mobile_dev", ko: "모바일 개발", en: "Mobile dev"),
            .init(key: "data_ml", ko: "데이터/ML", en: "Data / ML"),
            .init(key: "devops", ko: "DevOps/인프라", en: "DevOps / Infra"),
            .init(key: "qa", ko: "QA/테스트", en: "QA / Test"),
            .init(key: "design", ko: "디자인/UX", en: "Design / UX"),
