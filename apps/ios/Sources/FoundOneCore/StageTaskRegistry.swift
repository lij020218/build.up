...
public enum BUStageTaskRegistry {
    ...
    private static let stageMap: [String: [BUStageTask]] = [
        ...
        "permit-check": [
            ...
            .init(id: "hygiene-health-checked",      title: "위생교육 6시간·보건증 발급 요건 확인 (음식/카페/뷰티) — 절차·기간·발급처", estimatedMinutes: 15),
            .init(id: "license-registration-checked", title: "전문 면허·업종별 등록 요건 확인 (미용사 면허, 학원·체육시설·동물관련업 등록 등)", estimatedMinutes: 15),
            .init(id: "fire-safety-checked",         title: "소방완비증명서·시설 안전 요건 확인 — 영업장 면적·층수별 기준 점검", estimatedMinutes: 15),
        ],
        "contract-review": [
