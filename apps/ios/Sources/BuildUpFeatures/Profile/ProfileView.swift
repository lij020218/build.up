    ...
    private var supportCard: some View {
        profileCard(eyebrow: "SUPPORT · 지원", title: "도움말 및 지원") {
            VStack(spacing: 0) {
                supportRow(
                    title: "도움말",
                    url: URL(string: "https://buildup.kr/help")
                )
                divider
                supportRow(
                    title: "이용약관",
                    url: URL(string: "https://buildup.kr/terms")
                )
                divider
                supportRow(
                    title: "개인정보처리방침",
                    url: URL(string: "https://buildup.kr/privacy")
                )
                divider
                supportRow(
                    title: "문의하기",
                    url: URL(string: "mailto:support@buildup.kr")
                )
            }
        }
    }
