  ...
  "startup-tech": [
    {
      ...
      icon: "Copyright",
      subtitle: "특허 · 상표 · 디자인 · SW 저작권 출원/등록 상태",
      arrayItem: {
        titleField: "title",
        addLabel: "+ IP 추가",
        ...
        fields: [
          ...
          { key: "applicationNumber", label: "출원번호", type: "text", optional: true },
      ...
      arrayItem: {
        ...
        fields: [
          { key: "round", label: "라운드", type: "select", options: [
            ...
            { value: "convertible", label: "전환사채/SAFE" },
          ]},
          { key: "amountKrw", label: "투자 금액 (원)", type: "won" },
          { key: "valuationKrw", label: "기업가치 (원)", type: "won", optional: true },
    ...
    },
    {
      ...
      title: "벤처인증 · 정부지원",
      icon: "Stamp",
      subtitle: "예비창업·청년창업·벤처기업·이노비즈·R&D — 종료 D-day",
      arrayItem: {
        titleField: "name",
        addLabel: "+ 인증/지원사업 추가",
        emptyText: "예비창업패키지·청년창업·벤처인증·이노비즈·R&D 과제 추가",
        expiryKey: "endDate",
        fields: [
          { key: "name", label: "사업/인증명", type: "text", placeholder: "예: 예비창업패키지 / 벤처기업 인증" },
          { key: "kind", label: "구분", type: "select", options: [
            { value: "preliminary-startup", label: "예비창업패키지" },
            { value: "youth-startup", label: "청년창업사관학교" },
            { value: "venture-cert", label: "벤처기업 인증" },
          ...
          { key: "endDate", label: "종료일", type: "date", trackExpiry: true, optional: true },
          { key: "agency", label: "주관 기관", type: "text", optional: true },
        ],
      },
    },
  ],
