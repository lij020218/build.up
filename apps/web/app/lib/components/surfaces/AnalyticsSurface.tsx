    ...
    <>
            <section style={styles.section}>
              ...
              {(() => {
                ...
                const allEvents = [
                  ...(hasEmployees ? [
                    { label: ko ? "원천세 납부" : "Withholding tax", sub: ko ? "매월 10일" : "Monthly 10th", date: withholdingDate, icon: "원", color: "#3b5c8c", alwaysShow: false, url: "https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml", urlLabel: ko ? "홈택스 신고" : "File on HomeTax" },
                  ...
                  { label: ko ? "부가세 확정신고" : "VAT filing", sub: vatSub, date: vatDate, icon: "부", color: "#191970", alwaysShow: true, url: "https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml", urlLabel: ko ? "홈택스 신고" : "File on HomeTax" },
                  ...(vatType === "general" ? [
                    { label: ko ? "부가세 예정신고" : "VAT provisional", sub: ko ? "일반과세자 — 4·10월 25일" : "General VAT — Apr & Oct 25", date: vatProvisionalDate, icon: "예", color: "#ff6b00", alwaysShow: false, url: "https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml", urlLabel: ko ? "홈택스 신고" : "File on HomeTax" },
                  ] : []),
                  { label: ko ? "종합소득세" : "Income tax", sub: ko ? "매년 5월 31일" : "May 31 annually", date: incomeTaxDate, icon: "소", color: "#af52de", alwaysShow: true, url: "https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml", urlLabel: ko ? "홈택스 신고" : "File on HomeTax" },
                ...
                return (
                  <article style={{ ...styles.card, padding: "0", overflow: "hidden" as const, gap: "0", flex: 1 }}>
                    ...
                    <div style={{ padding: "12px 22px 16px", borderTop: "0.5px solid rgba(0,0,0,0.06)", display: "flex", gap: "6px", flexWrap: "wrap" as const }}>
                      {[
                        { label: ko ? "홈택스" : "HomeTax", url: "https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml", color: "#5856d6" },
                ...
                <section style={{ ...styles.section, marginTop: "32px" }}>
                  ...
                  <article style={{
                    ...
                    <div style={{ padding: "14px 22px 18px", display: "grid", gap: "6px" }}>
                      {[
                        { label: ko ? "폐업 절차 안내 (국세청)" : "Closure procedures (NTS)", desc: ko ? "사업자 폐업 신고, 부가세 확정신고, 폐업 세금 정리" : "Business closure filing, VAT final return, tax settlement", url: "https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml" },
