      ...
      <div style={{
        ...
        {dodDelta != null && (
          <span style={{
            ...
            background: dodDelta >= 0 ? "rgba(52,199,89,0.10)" : "rgba(182,76,76,0.10)",
            color: dodDelta >= 0 ? "#1d3557" : "#b32419",
            fontVariantNumeric: "tabular-nums" as const,
          }}>
        ...
        {wowDelta != null && (
          <span style={{
            ...
            padding: "3px 9px", borderRadius: "999px",
            fontSize: "10.5px", fontWeight: 700,
            background: wowDelta >= 0 ? "rgba(52,199,89,0.10)" : wowDelta <= -1 ? "rgba(182,76,76,0.10)" : "rgba(25,25,112,0.06)",
            color: wowDelta >= 0 ? "#1d3557" : wowDelta <= -1 ? "#b32419" : "rgba(25,25,112,0.55)",
            fontVariantNumeric: "tabular-nums" as const,
          }}>
