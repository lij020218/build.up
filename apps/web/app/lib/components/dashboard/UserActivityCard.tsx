      ...
      <div style={{
        ...
        {dodDelta != null && (
          <span style={{
            ...
            background: dodDelta >= 0 ? "rgba(29,53,87,0.10)" : "rgba(182,76,76,0.10)",
        ...
        {wowDelta != null && (
          <span style={{
            ...
            padding: "3px 9px", borderRadius: "999px",
            fontSize: "10.5px", fontWeight: 700,
            background: wowDelta >= 0 ? "rgba(29,53,87,0.10)" : wowDelta <= -1 ? "rgba(182,76,76,0.10)" : "rgba(25,25,112,0.06)",
