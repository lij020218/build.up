...
const BRANDS: Brand[] = [
  {
    name: "토스", tagline: "핀테크", color: "#0064ff",
    iconSlug: "toss", iconColor: "ffffff", glyph: "토",
  ...
  {
    name: "Notion", tagline: "Productivity", color: "#000000",
    iconSlug: "notion", iconColor: "ffffff", glyph: "N",
    founded: "2013, 샌프란시스코",
  ...
  {
    name: "쿠팡", tagline: "이커머스", color: "#cc0000",
    iconSlug: "coupang", iconColor: "ffffff", glyph: "쿠",
  ...
  {
    name: "Linear", tagline: "Engineering", color: "#5e6ad2",
    iconSlug: "linear", iconColor: "ffffff", glyph: "L",
    founded: "2019, 샌프란시스코",
  ...
  {
    name: "Airbnb", tagline: "Stays", color: "#ff385c",
    iconSlug: "airbnb", iconColor: "ffffff", glyph: "A",
    founded: "2008, 샌프란시스코",
  ...
  {
    name: "Stripe", tagline: "Payments", color: "#635bff",
    iconSlug: "stripe", iconColor: "ffffff", glyph: "S",
    founded: "2010, 샌프란시스코",
  ...
  {
    name: "OpenAI", tagline: "AI", color: "#10a37f",
    iconSlug: "openai", iconColor: "ffffff", glyph: "O",
  ...
  {
    name: "카카오", tagline: "메신저·O2O", color: "#fee500",
    iconSlug: "kakao", iconColor: "3c1e1e", glyph: "K", textColor: "#3c1e1e",
  ...
  {
    name: "Figma", tagline: "Design", color: "#1e1e1e",
    iconSlug: "figma", iconColor: "ffffff", glyph: "F",
  ...
  {
    name: "Vercel", tagline: "Hosting", color: "#000000",
    iconSlug: "vercel", iconColor: "ffffff", glyph: "▲",
  ...
  {
    name: "Discord", tagline: "Community", color: "#5865f2",
    iconSlug: "discord", iconColor: "ffffff", glyph: "D",
  ...
  {
    name: "GitHub", tagline: "Code", color: "#181717",
    iconSlug: "github", iconColor: "ffffff", glyph: "G",
  ...
  {
    name: "Anthropic", tagline: "Claude", color: "#cc785c",
    iconSlug: "anthropic", iconColor: "ffffff", glyph: "A",
    founded: "2021, 샌프란시스코",
  ...
  {
    name: "Spotify", tagline: "Music", color: "#1ed760",
    iconSlug: "spotify", iconColor: "ffffff", glyph: "♫",
  ...
  {
    name: "Slack", tagline: "Work chat", color: "#4a154b",
    iconSlug: "slack", iconColor: "ffffff", glyph: "S",
  ...
  // 한국 브랜드 — Simple Icons 미수록 → glyph
  {
    name: "배달의민족", tagline: "음식 배달", color: "#2ac1bc",
    glyph: "배",
  ...
  {
    name: "당근", tagline: "동네 거래", color: "#ff7e36",
    glyph: "당",
    founded: "2015.7, 판교",
  ...
  {
    name: "야놀자", tagline: "여행·숙박", color: "#ff5e1f",
    glyph: "야",
    founded: "2005, 한국",
  ...
  {
    name: "마켓컬리", tagline: "신선식품", color: "#5f0080",
    glyph: "컬",
  ...
  {
    name: "무신사", tagline: "패션", color: "#000000",
    glyph: "M",
    founded: "2003, 무신사닷컴",
