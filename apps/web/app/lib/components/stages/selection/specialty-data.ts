...
export const SPECIALTY_BY_INDUSTRY: Record<string, SpecialtyOption[]> = {
  ...
  "waxing-studio": [
    { id: "waxing-brazilian", label: "왁싱 전문샵 (브라질리언·전신)", desc: "브라질리언·전신 등 부위별 제모 — 왁싱 전문", labelEn: "Waxing studio" },
  ...
  "pilates-studio": [
    { id: "pilates-reformer", label: "리포머(기구) 필라테스", desc: "리포머·체어·바렐 등 기구 중심 — 시설 투자 큼 (그룹·1:1 모두 제공)", labelEn: "Reformer pilates" },
    { id: "pilates-mat-only", label: "매트 필라테스", desc: "기구 없이 매트 수업 — 소자본·좁은 공간", labelEn: "Mat pilates" },
  ],
  "pt-gym": [
    { id: "pt-gym-pt-hybrid", label: "종합 헬스장 (+PT)", desc: "머신·월회비 + PT 병행 — 넓은 공간, 가장 일반적", labelEn: "Full gym (+PT)" },
    { id: "pt-personal", label: "1:1 PT 스튜디오", desc: "트레이너 중심·회당 결제 — 소형·시설비↓", labelEn: "1:1 PT studio" },
    { id: "pt-unmanned-24", label: "무인 24시 헬스장", desc: "키카드 출입 + CCTV — 인건비↓", labelEn: "Unmanned 24h gym" },
    { id: "pt-rehab", label: "재활 운동센터 (메디컬 피트니스)", desc: "재활 수요·목적형 입지·의료 연계", labelEn: "Rehab / medical fitness" },
  ],
  "yoga-studio": [
    { id: "yoga-general", label: "일반 요가", desc: "하타·빈야사·아쉬탕가 등 — 그룹 수업 (명상·복원 등 프로그램 포함)", labelEn: "General yoga" },
    { id: "yoga-hot", label: "핫요가", desc: "고온 스튜디오 — 냉난방 시설 투자 큼", labelEn: "Hot yoga" },
    { id: "yoga-aerial", label: "에어리얼(플라잉) 요가", desc: "해먹·구조물 설비 — 별도 시설", labelEn: "Aerial yoga" },
  ],
  "crossfit-box": [
    { id: "crossfit-box", label: "크로스핏 박스", desc: "공식 affiliate — 박스 단위 그룹 WOD", labelEn: "CrossFit box" },
    { id: "fitness-hiit", label: "그룹 기능성·HIIT 짐", desc: "케틀벨·서스펜션·고강도 인터벌 — 소형 박스형", labelEn: "Functional / HIIT gym" },
    { id: "fitness-boxing", label: "복싱·킥복싱장", desc: "체력증진 + 스트레스 해소", labelEn: "Boxing gym" },
    { id: "fitness-spinning", label: "스피닝·인도어 사이클", desc: "음악 + 그룹 — 칼로리 소모", labelEn: "Spinning studio" },
  ...
  "ai-application": [
    ...
    { id: "su-ai-vertical", label: "버티컬 AI (특정 산업 특화)", desc: "법률·의료·교육 등 산업 특화", labelEn: "Vertical AI" },
  ...
  "creator-service": [
    ...
    { id: "su-creator-shorts", label: "쇼츠·릴스 자동화", desc: "쇼츠·릴스 배포·자동화 (제작 툴과 구분)", labelEn: "Shorts / Reels automation" },
  ...
  "developer-tools": [
    ...
    { id: "su-dev-security-test", label: "보안·취약점 스캐닝", desc: "개발자 워크플로우 내장 시프트레프트 보안 스캔", labelEn: "Security scanning" },
  ...
  "b2b-saas": [
    ...
    { id: "su-saas-vertical", label: "버티컬 SaaS (산업특화 워크플로우)", desc: "병원·식당·미용·법률 등 도메인", labelEn: "Vertical SaaS" },
  ...
  "consignment-commerce": [
    { id: "cc-dropship-general", label: "무재고 위탁판매 (국내 도매 소싱)", desc: "도매매·온채널 등 공급사 상품을 무재고로 판매 — 마진 수수료 모델", labelEn: "Domestic dropshipping" },
    { id: "cc-dropship-food", label: "식품 위탁판매", desc: "무재고여도 식품판매업·유통전문판매업 신고 필요", labelEn: "Food dropshipping" },
  ],
  ...
  "pet-cafe": [
    ...
    { id: "pc-bird", label: "새·앵무새 카페 (사육종)", desc: "사육 허용 조류 한정 — 야생종 영업 금지(2022 야생생물법)", labelEn: "Bird cafe" },
    { id: "pc-reptile", label: "파충류 카페 (사육종)", desc: "합법 사육 파충류 한정 — 야생동물 지정종 제외", labelEn: "Reptile / exotic cafe" },
  ],
  "pet-supplies": [
    { id: "ps-food", label: "사료·간식 전문", desc: "프리미엄 사료·수제 간식", labelEn: "Pet food / treats" },
    { id: "ps-toys", label: "펫용품 종합샵", desc: "장난감·의류·용품 종합 취급", labelEn: "Pet toys / supplies" },
  ...
  "golf-studio": [
    { id: "gs-screen", label: "스크린 골프", desc: "골프존·카카오 등 스크린 — 가장 보편", labelEn: "Screen golf" },
    { id: "gs-lesson-indoor", label: "실내 골프연습·레슨", desc: "타석 + 1:1 레슨·스윙 분석 — 시간 단위", labelEn: "Indoor golf lesson/range" },
    { id: "gs-outdoor-range", label: "야외 골프연습장", desc: "드라이빙 레인지 — 넓은 부지", labelEn: "Outdoor driving range" },
  ],
  "unmanned-fitness": [
    { id: "uf-24h-gym", label: "무인 24시 헬스장", desc: "키카드 출입 + CCTV — 인건비↓ (반무인·셀프 키오스크 포함)", labelEn: "Unmanned 24h gym" },
    { id: "uf-yoga-room", label: "무인 요가룸 (예약제)", desc: "매트·소품 + QR 예약", labelEn: "Unmanned yoga room" },
    { id: "uf-pilates-machine", label: "무인 필라테스", desc: "리포머 셀프 — 예약제", labelEn: "Unmanned pilates" },
  ],
};
