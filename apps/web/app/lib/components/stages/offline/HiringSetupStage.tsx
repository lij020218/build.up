      ...
      {pageIdx === 4 && (
        <WorkStep
          ...
          how={[
            ...
            { title: ko ? "퇴직금 — 5인 미만도 의무 (주 15h↑ + 1년↑ 근속)" : "Severance — mandatory even under 5 (15h+/wk, 1yr+)", detail: ko ? "연장수당과 달리 퇴직금은 사업장 규모 무관. 「5인 미만은 안 줘도 된다」는 흔한 오해 — 주 15시간 이상 + 1년 이상 근속이면 알바·일용직도 의무. 30일분 평균임금 이상, 미지급 시 임금체불(형사처벌·지연이자). 매달 1/12씩 적립 권장." : "Unlike OT, severance applies regardless of headcount. The 'under-5 exempt' belief is a myth — 15h+/wk and 1yr+ tenure = mandatory (incl. part-time/daily). ≥30 days' avg wage; non-payment = wage theft (criminal + interest). Reserve 1/12 monthly." },
