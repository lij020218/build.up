...
export function OperationsSetupStage() {
  ...
  const wrapupVerifyItems = isFood
    ? [
        ...
        "위생교육 매년 갱신 — 식품접객업 영업자(대표자) 대상 (일반 음식점 종업원은 연간 위생교육 대상 아님), 미이수 시 과태료(100만원 이하)",
        "민원 대응 — 식약처·소비자원 신고 24시간 내 대응 룰 + 사진·영상 증빙 자동 보관 시스템",
        "원산지 표시 — 농수산물 원산지표시법 지정 품목(쇠·돼지·닭고기·쌀·배추김치·주요 수산물 등)만 의무 (전 메뉴 아님). 거짓 표시 시 7년 이하 징역·1억원 이하 벌금 / 미표시 시 1,000만원 이하 과태료",
