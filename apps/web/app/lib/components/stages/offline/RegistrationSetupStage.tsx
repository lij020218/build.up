...
const PERMIT_BY_CATEGORY: Record<string, PermitInfo> = {
  food: {
    ...
    description: "식품을 조리·판매하는 매장은 영업신고 필수. 미신고 영업 시 1차 100만원 과태료 + 영업장 폐쇄 명령",
  },
  "cafe-dessert": {
    kind: "신고",
  ...
  pet: {
    ...
    requirements: [
      ...
      "환기·소독·배수 시설",
      "동물 학대·방치 금지 (법적 책임)",
      "펫 호텔 운영 시 동물위탁관리업 별도 등록",
    ],
    externalUrl: "https://www.gov.kr",
    description: "펫 미용·호텔·훈련소 모두 동물보호법상 영업등록 의무. 무등록 영업 시 형사처벌",
  },
  retail: {
    kind: "신고",
            ...
            {[
              {
                ...
                body: "사업개시일로부터 20일 이내 사업자등록 의무 (부가가치세법). 인허가 업종 미신고 영업 시 1차 100만원 과태료 + 영업장 폐쇄 명령까지 가능합니다.",
              },
              {
                accent: "#0561fc",
                title: "운영 인프라의 전제 조건",
