    ...
    <div style={{ marginBottom: "16px", display: "flex", flexDirection: "column", gap: "14px" }}>
      ...
      <div style={{ borderRadius: "20px", border: `1px solid ${MIDNIGHT_BORDER}`, background: "white", overflow: "hidden", boxShadow: "0 1px 3px rgba(25,25,112,0.04)" }}>
        ...
        <div style={{ padding: "0 22px 18px" }}>
          ...
          <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
            <a href="https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml" target="_blank" rel="noopener noreferrer" style={linkStyle}>홈택스 바로가기 ↗</a>
        ...
        <div style={{ padding: "0 22px 18px" }}>
          ...
          <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
            ...
            <a href="https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml" target="_blank" rel="noopener noreferrer" style={{ ...linkStyle, color: MIDNIGHT, background: "rgba(25,25,112,0.04)", border: "1px solid rgba(25,25,112,0.08)" }}>홈택스 ↗</a>
          </div>
      ...
      <div style={{ borderRadius: "20px", border: "1px solid rgba(25,25,112,0.08)", background: "white", padding: "20px 22px" }}>
        ...
        <div style={{ marginTop: "10px", display: "flex", gap: "6px", flexWrap: "wrap" }}>
          <a href="https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index_pp.xml" target="_blank" rel="noopener noreferrer" style={linkStyle}>홈택스 ↗</a>
