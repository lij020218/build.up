...
const APP_LAUNCH_METHODS: BuildMethod[] = [
  ...
  },
  {
    ...
    tagline: "2026 정책: iOS 26 SDK + Xcode 16+ 필수 (4.28부터). 평균 24h 리뷰지만 최근 7-30일 지연 빈발.",
    tools: [
      { name: "Apple Developer Program", url: "https://developer.apple.com/programs", pricing: "$99/년" },
      { name: "Xcode 16+", url: "https://apps.apple.com/app/xcode/id497799835", pricing: "무료" },
    ...
    steps: [
      ...
      { title: "Xcode 16+ 에서 archive → App Store Connect 업로드", detail: "2026.4.28 이후 모든 앱은 iOS 26 SDK + Xcode 16+ 의무. archive → Validate → Upload." },
