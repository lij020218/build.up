              ...
              {(ko ? [
                ...
                },
                {
                  ...
                  tools: [
                    ...
                    { name: "Stripe", url: "https://stripe.com", price: "거래당 2.9%+$0.3 (글로벌)" },
                    { name: "Paddle (MoR)", url: "https://paddle.com", price: "거래당 5%+$0.5 — VAT 자동" },
                ...
                },
                {
                  num: 3,
                  Icon: AlertTriangle,
                  title: "에러·로그·업타임 (Observability)",
                  why: "사용자는 에러 만나면 말 없이 떠남. \"안 쓴다\" 라고 생각한 게 사실은 \"못 쓴 것\" 인 경우 많음. 에러(Sentry) + 로그(Axiom/BetterStack) + 업타임(Better Uptime) 3종 셋트가 2026 표준. 10-20분 셋업.",
                  todo: ["Sentry SDK 설치 (Next.js 공식 + 에러·perf·세션 리플레이)", "Slack 알림 연동 + 매일 대시보드 확인", "구조화 로그 → Axiom/BetterStack (Vercel/Cloudflare 함수 로그 통합)", "uptime 모니터 (Better Uptime/Cronitor) + 공개 statuspage"],
                  tools: [
                    { name: "Sentry", url: "https://sentry.io", price: "무료 5K 이벤트/월" },
                    { name: "Highlight.io", desc: "OSS — 세션 리플레이 + 에러", url: "https://highlight.io", price: "무료" },
                    { name: "BetterStack", desc: "로그+업타임+statuspage 통합", url: "https://betterstack.com", price: "$25/mo부터" },
                    { name: "Axiom", desc: "이벤트·로그 cheap (1B/mo $25)", url: "https://axiom.co", price: "무료 500GB/mo" },
                    { name: "Better Uptime / Cronitor", desc: "1분 체크 + Slack/Discord 알림", url: "https://betteruptime.com", price: "무료 10개 모니터" },
                  ],
                },
                {
                  num: 4,
