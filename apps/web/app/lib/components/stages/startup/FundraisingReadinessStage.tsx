              ...
              <div style={{ marginTop: "12px", display: "flex", gap: "8px" }}>
                <button type="button" onClick={() => {
                  try {
                    ...
                    doc.setFontSize(18);
                    doc.text(bpSummary || "Business Plan", margin, y, { maxWidth: maxW });
                    y += 12;
                    ...
                    for (const sec of bpSections) {
                      ...
                      const titleLines = doc.splitTextToSize(sec.title, maxW);
                      ...
                      const contentLines = doc.splitTextToSize(sec.content, maxW);
                    ...
                    for (let i = 1; i <= pages; i++) {
                      ...
                      doc.text(`Generated by Build.UP  |  Page ${i}/${pages}`, pageW / 2, 290, { align: "center" });
                    }

                    doc.save(`business-plan-${new Date().toISOString().slice(0, 10)}.pdf`);
                  } catch (e) {
