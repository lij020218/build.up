...
export function StageGuideViewer() {
  ...
  const registrationSetupEl: React.ReactNode = (() => {
    ...
    const step1: RegStepData = {
      ...
      links: ko ? [
        { text: "\uad6d\uc138\uccad \ud648\ud0dd\uc2a4 \u2014 \uc0ac\uc5c5\uc790\ub4f1\ub85d \uc2e0\uccad", href: "https://hometax.go.kr/websquare/websquare.html?w2xPath=%2Fui%2Fpp%2Findex_pp.xml" },
        { text: "KIPRIS \u2014 \uc0c1\ud45c\xb7\uc0c1\ud638 \uac80\uc0c9", href: "https://www.kipris.or.kr" },
      ] : [
        { text: "Hometax \u2014 Business registration", href: "https://hometax.go.kr/websquare/websquare.html?w2xPath=%2Fui%2Fpp%2Findex_pp.xml" },
    ...
    const step4: RegStepData = {
      ...
      links: ko ? [
        ...
        { text: "\ud648\ud0dd\uc2a4 \u2014 \ud604\uae08\uc601\uc218\uc99d \uac00\ub9f9 \uc2e0\uccad", href: "https://hometax.go.kr/websquare/websquare.html?w2xPath=%2Fui%2Fpp%2Findex_pp.xml" },
        ...
        { text: "Hometax \u2014 cash receipt merchant", href: "https://hometax.go.kr/websquare/websquare.html?w2xPath=%2Fui%2Fpp%2Findex_pp.xml" },
