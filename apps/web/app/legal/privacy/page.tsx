    ...
    <div style={{
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <Section title="1. 개인정보처리자 정보">
          <p>build.up (이하 "회사" 또는 "서비스")는 창업자 및 소상공인을 위한 경영 지원 서비스를 제공하며, 개인정보보호법에 따라 이용자의 개인정보를 보호하고 관련 고충을 신속하게 처리합니다.</p>
          <Table rows={[
            ["서비스명", "build.up"],
            ["운영 책임자", "대표자 (이메일 문의)"],
            ["개인정보 보호 책임자", "lki720412@gmail.com"],
            ["서비스 URL", "https://buildup.kr"],
          ]} />
        </Section>
        ...
        <Section title="2. 수집하는 개인정보 항목">
          ...
          <Table rows={[
            ["수집 항목", "수집 목적", "보유 기간"],
            ["이메일 주소, 비밀번호(해시)", "회원가입 및 로그인 인증", "회원 탈퇴 시 즉시 삭제"],
            ["상호명, 업종, 창업일", "맞춤형 경영 분석 제공", "서비스 이용 기간"],
        ...
        <Section title="5. 개인정보 처리 위탁">
          <Table rows={[
            ...
            ["Anthropic PBC / OpenAI LLC", "AI 분석 처리 (익명화 후 전달)", "처리 즉시 삭제"],
            ["PortOne (KG이니시스)", "결제 처리", "5년 (전자상거래법)"],
            ["Upstash Inc.", "API 요청 제한 처리 (키만 저장)", "24시간"],
          ]} isHeader />
        </Section>

        <Section title="6. 개인정보 보유 및 이용 기간">
