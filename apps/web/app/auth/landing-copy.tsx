...
export function getSummaryFeatures(lang: Language) {
  ...
  return [
    ...
    { color: "#191970", d: "M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z", title: ko ? "재고 관리" : "Inventory", desc: ko ? "공급업체 기반 입력" : "Supplier-linked input" },
    { color: "#3b5c8c", d: "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 7a4 4 0 100 8 4 4 0 000-8zM23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75", title: ko ? "직원 관리" : "Team Management", desc: ko ? "인건비 자동 반영" : "Auto labor cost sync" },
