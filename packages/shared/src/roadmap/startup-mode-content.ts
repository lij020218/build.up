...
export const STARTUP_STAGE_MODE_CONTENT: Record<string, Record<OperatingMode, ModeStageContent>> = {
  ...
  "company-setup": {
    indie: {
      why: "1인이라면 '개인사업자' 가 가장 빠르고 저렴. 간이과세 가능 (연 1.4억 미만)으로 부가세 부담 작음. 법인 설립은 매출 1억 넘거나 외부 투자 받을 때.",
      actions: [
        { title: "개인사업자 등록 (홈택스 5분, 무료)", detail: "사업자등록번호 즉시 발급. 간이과세 자격 확인 (연 1.4억 미만 시 1.4% 부가세)." },
      ...
      evidence: "한국 간이과세 기준 2026년 1억 4천만원 (상향). 솔로 founder $30/mo 시작 (FindSkill.ai 2026).",
    },
    bootstrap: {
