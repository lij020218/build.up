...
const stageCopy: Record<string, { ko: { title: string; goal: string; whyNow: string } }> = {
  ...
  insurance_tax_setup: { ko: { title: "직원 채용 의무 — 근로계약·4대보험·급여 세팅", goal: "첫 직원 채용 시 즉시 발생하는 4가지 의무: ① 근로계약서 작성 (미체결 시 500만원 과태료) ② 4대보험 가입 (건강 14일·기타 익월 15일) ③ 원천세 매월 신고 ④ 급여 시스템 결정 (수기·세무사·SaaS).", whyNow: "직원 1명만 채용해도 4대보험 취득 신고 의무 (건강 14일·기타 익월 15일). 미신고 = 가산세 + 소급납부. 두루누리 80% 지원 (270만 미만, 10인 미만, 36개월) 신고 시점에만 신청 가능 — 놓치면 비용 폭증." } },
