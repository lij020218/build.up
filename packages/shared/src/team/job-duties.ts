...
export const DUTIES_BY_CATEGORY: Record<string, JobDuty[]> = {
  ...
  "startup-tech": [
    { key: "backend", ko: "백엔드 개발", en: "Backend" },
    { key: "frontend", ko: "프론트엔드 개발", en: "Frontend" },
    { key: "fullstack", ko: "풀스택 개발", en: "Full-stack" },
    { key: "mobile_dev", ko: "모바일 개발", en: "Mobile dev" },
    { key: "data_ml", ko: "데이터/ML", en: "Data / ML" },
    { key: "devops", ko: "DevOps/인프라", en: "DevOps / Infra" },
    { key: "qa", ko: "QA/테스트", en: "QA / Test" },
    { key: "design", ko: "디자인/UX", en: "Design / UX" },
