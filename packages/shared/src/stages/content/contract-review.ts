...
export const CONTRACT_REVIEW_CONTENT: StageContent = {
      ...
      sections: [
        {
          ...
          watchouts: [
            { label: "임대료 5% 상한 — 환산보증금 이내는 미명시라도 자동 적용, 초과 계약만 특약 필수", text: "⚠ 환산보증금 상한 — 서울 9억, 과밀억제권역·부산 6.9억, 기타 광역시·세종·파주·화성·안산·용인·김포·광주 5.4억, 그 밖 3.7억 (상가건물 임대차보호법 시행령 §2, 2025.3.1). 환산보증금 = 보증금 + (월세 × 100). 이내면 계약서에 안 적어도 법정 연 5% 상한 자동 적용, 초과면 5% 상한·우선변제권 적용 X → 특약에 「갱신 시 5% 이내」 명시해야 안전. ✓ 대항력·계약갱신요구권(10년)·권리금 회수기회는 환산보증금 상관없이 모든 임차인에게 적용." },
      ...
      sections: [
        {
          ...
          tasks: [
            { id: "sign-1", title: "관할 세무서 방문 (상가 확정일자)", detail: "상가건물 임대차 확정일자는 상가 소재지 관할 세무서장이 부여(주택과 달리 동주민센터 X). 임대차계약서 + 신분증 지참, 수수료 무료(상가 확정일자 부여는 무료 — 주택과 혼동 주의), 30분 안에 끝남 — 평일 방문." },
      ...
      sections: [
        ...
        { kind: "interactive", ref: "contractSign" },
        {
          ...
          items: [
            ...
            "확정일자 받기 — 관할 세무서 (상가는 세무서, 주택과 다름 · 수수료 무료). 임대인 파산 시 보증금 우선변제권 확보",
            "사업자등록 신청 (관할 세무서) — 상가 대항력 요건은 건물 인도 + 사업자등록 (주택의 전입신고 아님). 확정일자까지 받으면 우선변제권 확보",
          ],
        },
  ...
  wrapup: {
    ...
    doneItems: [
      ...
      { label: "4. 사인 + 당일 확정일자", detail: "관할 세무서 30분 — 수수료 무료 — 보증금 우선변제권 확보" },
    ],
    verifyItems: [
