...
export const CONTRACT_REVIEW_CONTENT: StageContent = {
  ...
  keyAction: {
    ...
    pillars: [
      { icon: "building", label: "건물", meta: "용도 · 정화조 · 전기" },
      ...
      sections: [
        {
          ...
          workOutline: [
            ...
            { title: "사인 + 확정일자", detail: "사인 즉시 확정일자 (동주민센터)", time: "당일" },
      ...
      sections: [
        {
          ...
          tasks: [
            { id: "doc-1", title: "건축물대장 발급 (정부24·무료·5분)", detail: "정부24 → 「건축물대장 등본」 검색 → PDF 다운. 「용도」 + 「위반건축물」 표시 + 「정화조 BOD 용량」 확인." },
      ...
      sections: [
        {
          ...
          tasks: [
            { id: "site-1", title: "영상 기록 — 매장 전체 + 외부 + 시설", detail: "휴대폰으로 한 번에 쭉 촬영. 누수·곰팡이·전기 패널·환기 후드·정화조 위치까지. 분쟁 시 증거." },
            { id: "site-2", title: "옆 가게 점주에게 3개 질문", detail: "「이 건물주 어때요?」 + 「임대료 어떻게 인상하세요?」 + 「민원 자주 있나요?」 — 임대인 평판 80% 노출." },
            { id: "site-3", title: "전기 용량·정화조 용량 직접 확인", detail: "전기 패널 30A 표기 확인 + 건물 외부 정화조 위치·크기 확인. 임대인 답변과 다르면 협상 카드." },
          ],
          watchouts: [
      ...
      sections: [
        {
          ...
          tasks: [
            { id: "sign-1", title: "관할 동주민센터 또는 세무서 방문", detail: "임차물건 주소 관할. 1,000원 수수료. 30분 안에 끝남. 토요일 일부 가능 — 평일에 사인하는 게 안전." },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { id: "facility", label: "후드·간판·덕트 설치 허용 특약 확인" },
