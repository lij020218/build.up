...
## 한국 소상공인 창업 비용 기준 (2025-2026)
- 카페: 평균 1.17억원 (보증금 3,000만 + 인테리어 5,000만 + 설비 2,000만 + 운전자금 2,000만)
- 음식점: 평균 1.5-2억원 (보증금 5,000만 + 인테리어 6,000만 + 설비 3,000만)
- 치킨 프랜차이즈: 약 5,600만원
- 소매: 평균 8,000만-1.5억원
- 온라인/디지털: 평균 2,000만-5,000만원
- 스타트업: 시드 평균 3억원 (밸류 기준)

## 손익분기 달성 기간 벤치마크
- 1인 사업: 평균 15.3개월
- 외식업: 12-18개월
- 카페: 18-24개월 (초기 인지도 구축 기간 긴 편)
- 소매: 6-12개월
- 스타트업: 24-36개월 (SaaS 기준)
...
- 5년 내 폐업: 56%
- 평균 부채액(폐업 시): 1.02억원
- 폐업 후 78.2%가 정부 지원 프로그램 미활용

## 한국 창업 자금 지원 프로그램
- 소상공인 정책자금: 금리 ~2.96%, 운전자금 최대 5억
- 예비창업패키지: 최대 1억원 (사업화자금 + 멘토링)
- 초기창업패키지: 최대 1억원 (창업 3년 이내)
- 청년창업자금: 최대 1억원 (만 39세 이하, 금리 2.5% 고정)
- TIPS: R&D 최대 8억원 (기술 스타트업)
